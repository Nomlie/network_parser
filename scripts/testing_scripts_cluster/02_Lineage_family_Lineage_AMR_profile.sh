#!/bin/bash
# =============================================================================
# Biological 4-level hierarchy:
#   Lineage_family → Lineage_clean → AMR_binary → Resistance_Profile_Collapsed
# Lineage_family is a biologically motivated coarse grouping of major lineages
# (not the artificial test Lineage_Supergroup).
# =============================================================================
set -euo pipefail
...
# Ensure META / EVALUATION_META include Lineage_family
...
RUN_NAME="Hierarchy_Lineage_family_Lineage_AMR_Profile_02"
RUN_DIR="${BASE_OUT}/${RUN_NAME}"
HIER_LABELS=(Lineage_family Lineage_clean AMR_binary Resistance_Profile_Collapsed)
...
"${PYTHON_BIN}" -m network_parser.cli train-hierarchy \
  ...
  --hierarchy_preset lineage_family_amr_profile \
...
# ---------------------------------------------------------------------------
# 5. Panel annotation + stable + circularity
# ---------------------------------------------------------------------------
